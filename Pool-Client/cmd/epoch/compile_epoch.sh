...
echo "Compiling SmartPool epoch data setter..."
mustrun build/env.sh go build -ldflags -s -o epoch cmd/epoch/main.go
echo "Done. You can run SmartPool by ./epoch --help"
